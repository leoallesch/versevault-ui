...
#define LV_STDARG_INCLUDE   <stdarg.h>
    ...
    /** ESP32-C6 has ~327KB usable DRAM; leave headroom for stack/other. */
...
/** Smaller layer buffer to fit in DRAM */
...
#define LV_ATTRIBUTE_LARGE_CONST    IRAM_ATTR
...
/*==================
 * DEVICES — no host display drivers on embedded
 *==================*/
#define LV_USE_SDL          0
#define LV_USE_X11          0
